             ...
             <div className="bg-slate-100 p-4 rounded-2xl border-2 border-dashed space-y-4">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                       ...
                       <Select value={newPrize.type} onValueChange={v => setNewPrize(p=>({...p, type: v, productId: 'none', value: ''}))}>
                    ...
                    <div className="space-y-1">
                       {newPrize.type === "PRODUCT" ? (
                         <>
                           ...
                           <Select value={newPrize.productId} onValueChange={v => setNewPrize(p=>({...p, productId: v}))}>
                              <SelectTrigger className="bg-white"><SelectValue/></SelectTrigger>
                              <SelectContent>
